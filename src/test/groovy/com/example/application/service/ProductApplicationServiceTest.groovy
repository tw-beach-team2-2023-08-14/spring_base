...
class ProductApplicationServiceTest extends Specification {
    ...
    def "should return all products"() {
        ...
        List<ProductDto> expectedProductList = [
                new ProductDto(id: 1, name: "book", price: BigDecimal.valueOf(10L), discount: null, salePrice: null, status: "VALID"),
                new ProductDto(id: 2, name: "book2", price: BigDecimal.valueOf(10L), discount: BigDecimal.valueOf(0.9D), salePrice: BigDecimal.valueOf(9D), status: "INVALID"),
